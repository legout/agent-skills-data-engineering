...
### Core Files
- **`flowerpower/SKILL.md`** - Main skill instructions and quick reference
- **`flowerpower/references/overview.md`** - Key concepts and architecture
- **`flowerpower/references/configuration.md`** - Complete YAML configuration guide
- **`flowerpower/references/hamilton-patterns.md`** - Hamilton function patterns
...
This skill is licensed under the MIT License (see repository metadata and marketplace manifest).
